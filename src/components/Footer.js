const Footer = () => {
  ...
  return (
    <footer className="md:h-[120px] px-[20px] lg:px-0 bg-slate-100">
      <div className='flex flex-col md:flex-row justify-between items-center mx-auto max-w-[1024px] border-t-[1px] border-primary p-[20px]'>
